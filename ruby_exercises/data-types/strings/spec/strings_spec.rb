RSpec.describe 'Strings' do
  ...
  it 'test 6' do
    word = "ticking"
    # In place of the line below, call a method to achieve the expected output.
    actual = word.gsub(word,"clocking")
    expected = "clocking"
  ...
  it 'test 12' do
    rhyme = "eeny, meeny, miny, moe"
    # In place of the line below, call a method to achieve the expected output.
    actual = rhyme.delete("aeiouAEIOU")
  ...
  it 'test 17' do
    ...
    actual = greeting.count("aeiouAEIOU")
    expected = 3
