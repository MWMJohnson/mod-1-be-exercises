RSpec.describe 'Hashes' do
  ...
  it 'test 17' do
    ...
    # There are potentially two methods that work for `test 17`.
    # The first is below using the `count` method. - MWJ
    num_pairs = ages.count

    # The second is the `size` method utilized below
    # Take turns/toggle commenting out lines 232 and 236, to ensure test works when calling each method. - MWJ
    num_pairs = ages.size

    expect(num_pairs).to eq(4)
  end
